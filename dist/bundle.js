(function (global, factory) {
  ...
  function fetchTranslationsFor(newLocale) {
    return $.getJSON(`${STAGING_CDN_URL}/shared/service_catalog/dist/public/${newLocale}.json`);
  }
  ...
  function serviceCatalogEmpty(ezoSubdomain) {
    ...
    const serviceCategoryImage            = $('<img>').attr('src', `${STAGING_CDN_URL}/shared/service_catalog/dist/public/service_category.svg`)
                                                      .addClass('no-access-image');
  ...
  function noResultsFound() {
    ...
    const noResultsImage      = $('<img>').attr('src', `${STAGING_CDN_URL}/shared/service_catalog/dist/public/no_results_found.svg`)
