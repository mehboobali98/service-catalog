(function (global, factory) {
  ...
  const TRANSLATIONS                      = {};
  const STAGING_CDN_URL$1                   = 'https://cdn.inventoryontrack.com';
  ...
  function placeholderImagePath(serviceItem) {
    ...
    return `${STAGING_CDN_URL$1}/shared/service_catalog/assets/images/svg/${imageName}.svg`;
  }
  ...
  function serviceCatalogDisabled(ezoSubdomain) {
    ...
    const noAccessImage                   = $('<img>').attr('src', `${STAGING_CDN_URL$1}/shared/service_catalog/dist/public/assets/images/svg/no_access_image.svg`)
  ...
  function serviceCatalogEmpty(ezoSubdomain) {
    ...
    const serviceCategoryImage            = $('<img>').attr('src', `${STAGING_CDN_URL$1}/shared/service_catalog/dist/public/assets/images/svg/service_category.svg`)
                                                      .addClass('no-access-image');
  ...
  function noResultsFound() {
    ...
    const noResultsImage      = $('<img>').attr('src', `${STAGING_CDN_URL$1}/shared/service_catalog/dist/public/assets/images/svg/no_results_found.svg`)
  ...
  function noServiceItems(notFoundMessageKey) {
    ...
    const noResultsImage      = $('<img>').attr('src', `${STAGING_CDN_URL$1}/shared/service_catalog/dist/public/assets/images/svg/service_asset.svg`)
                                          .addClass('no-results-image');
  ...
  class ServiceCatalogManager {
    ...
    filesToLoad() {
      return [
                ...
                { type: 'link',   url: `${STAGING_CDN_URL$1}/shared/service_catalog/dist/public/stylesheets/service_catalog.css?${this.timeStamp}`},
