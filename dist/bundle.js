(function (global, factory) {
  ...
  function serviceCatalogEmpty(ezoSubdomain) {
    ...
    const serviceCategoryImage            = $('<img>').attr('src', `${PRODUCTION_CDN_URL}/shared/service_catalog/dist/public/images/svg/service_category.svg`)
                                                      .addClass('no-access-image');
  ...
  function noResultsFound() {
    ...
    const noResultsImage      = $('<img>').attr('src', `${PRODUCTION_CDN_URL}/shared/service_catalog/dist/public/images/svg/no_results_found.svg`)
  ...
  function noServiceItems(notFoundMessageKey) {
    ...
    const noResultsImage      = $('<img>').attr('src', `${PRODUCTION_CDN_URL}/shared/service_catalog/dist/public/images/svg/service_asset.svg`)
                                          .addClass('no-results-image');
