...
class ServiceCatalogBuilder {
  ...
  noAccessPage() {
    ...
    const noAccessImage         = $('<img>').attr('src', 'https://raw.githubusercontent.com/mehboobali98/service-catalog/connect_service_catalog_with_api/v1/assets/svg/no_access_image.svg');
